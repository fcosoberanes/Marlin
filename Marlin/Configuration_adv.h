 ...
 */
  ...
  #define THERMAL_PROTECTION_PERIOD 10        // Seconds 40
   ...
   * below 2.
   */
  #define WATCH_TEMP_PERIOD  10               // Seconds: 300 seconds
 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_PERIOD        10 // Seconds 30
  #define THERMAL_PROTECTION_BED_HYSTERESIS     1 // Degrees Celsius

  /**
   * As described above, except for the bed (M140/M190/M303).
   */
  #define WATCH_BED_TEMP_PERIOD                10 // Seconds 300
 ...
 */
   ...
   */
  #define WATCH_CHAMBER_TEMP_PERIOD            10 // Seconds 60
